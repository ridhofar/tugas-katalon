...
WebUI.setText(findTestObject('Object Repository/Page_Profile  Dashboard -/input_Username or email_username'), user)

WebUI.setText(findTestObject('Object Repository/Page_Profile  Dashboard -/input_Password_password'), password)
